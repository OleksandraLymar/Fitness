                                            ...
                                            <ul>
                                                ...
                                                <li><a href="about.html" className="active">Pages <i
                                                    ...
                                                    <ul className="sub-menu">
                                                        ...
                                                        <li><a href="wishlist.html" className="active">Wishlist</a></li>
                                                    </ul>
                                                </li>
                        ...
                        <div className="row">
                            <div className="col-xl-12">
                                <div className="page__title-content text-center">
                                    <h3 className="breadcrumb-title breadcrumb-title-sd mb-15">your Wishlist</h3>
                                ...
                                <form action="#">
                                    <div className="table-content table-responsive">
                                        <table className="table">
                                            ...
                                            <tr>
                                                <td className="product-thumbnail"><a href="shop-details.html"><img
                                                    src="assets/img/product/cart3.jpg" alt=""/></a></td>
                                                <td className="product-name"><a href="shop-details.html">Weight Trump (±
                                                    50 kg)</a></td>
                                                <td className="product-price"><span className="amount">$10.50</span>
                                                </td>
                                                <td className="product-quantity">
                                                    <div className="cart-plus-minus cdcart-plus-minus"><input
                                                        type="text" value="1"/>
                                                ...
                                                <td className="product-subtotal"><span className="amount">$10.50</span>
                                                </td>
                                                <td className="product-remove"><a href="#"><i
                                                    className="fa fa-times"></i></a></td>
                                            </tr>
