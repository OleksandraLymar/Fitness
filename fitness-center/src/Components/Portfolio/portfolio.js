export default function Portfolio() {
    ...
    return (
        <section className="about-section text-center" id="portfolio">
            <body>
            <div id="preloader">
                                    ...
                                    <div className="main-menu">
                                        <nav id="mobile-menu">
                                            <ul>
                                                ...
                                                <li><a href="protfolio.html" className="active">Portfolio <i
                                                    className="fal fa-plus dropdown-icon"></i></a>
                                                    <ul className="sub-menu">
                                                        <li><a href="protfolio.html" className="active">Portfolio </a>
                                                        </li>
            ...
            <main>
                        ...
                        <div className="row">
                            <div className="col-xl-12">
                                <div className="page__title-content text-center">
                                    <h3 className="breadcrumb-title breadcrumb-title-sd mb-15">our portfolio</h3>
                ...
                <div className="portfolio_area pt-115 pb-110">
                    <div className="container custome-container">
                        <div className="section-wrap-two text-center">
                            <span className="tpsub-title-two mb-15"><i className="far fa-circle"></i>our portfolio<i
                        ...
                        <div className="row mt-60">
                            <div className="col-lg-12">
                                <div className="portfolio-menu text-center filter-button-group mb-40">
                                    <button className="active" data-filter="*">All</button>
                                    <button data-filter=".c1" className="">Health</button>
                                    <button data-filter=".c2" className="">Fitness</button>
                                    <button data-filter=".c3" className="">nutrition</button>
                                    <button data-filter=".c4" className="">Cardio</button>
                                    <button data-filter=".c5" className="">Training</button>
                                </div>
                            </div>
                        </div>
                        <div className="row grid">
                            <div className="col-lg-6 c2 c3 c4">
                                <div className="single_portfolio_item mb-30">
                                    <div className="portfolio_image">
                                        <a href="protfolio-details.html"> <img src="assets/img/protfolio/portfolio1.jpg"
                                                                               alt=""/></a>
                                    </div>
                                    <div className="portfolio-info">
                                        ...
                                        <div className="portfolio_d-icon">
                                            <a href="protfolio-details.html" className="tp-btn-circle"><i
                                                className="fal fa-chevron-double-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-6 c1 c3 c5">
                                <div className="single_portfolio_item mb-30">
                                    <div className="portfolio_image">
                                        <a href="protfolio-details.html"><img src="assets/img/protfolio/portfolio2.jpg"
                                                                              alt=""/></a>
                                    </div>
                                    <div className="portfolio-info">
                                        <div className="portfolio-content">
                            ...
                            <div className="col-lg-6 c1 c3 c5">
                                <div className="single_portfolio_item mb-30">
                                    <div className="portfolio_image">
                                        <a href="protfolio-details.html"><img src="assets/img/protfolio/portfolio3.jpg"
                                                                              alt=""/></a>
                                    </div>
                                    <div className="portfolio-info">
                                        <div className="portfolio-content">
                            ...
                            <div className="col-lg-6 c2 c4 c5">
                                <div className="single_portfolio_item mb-30">
                                    <div className="portfolio_image">
                                        <a href="protfolio-details.html"><img src="assets/img/protfolio/portfolio4.jpg"
                                                                              alt=""/></a>
                                    </div>
                                    <div className="portfolio-info">
                                        <div className="portfolio-content">
                            ...
                            <div className="col-lg-6 c2 c1 c4 c3">
                                <div className="single_portfolio_item mb-30">
                                    <div className="portfolio_image">
                                        <a href="protfolio-details.html"><img src="assets/img/protfolio/portfolio5.jpg"
                                                                              alt=""/></a>
                                    </div>
                                    <div className="portfolio-info">
                                        <div className="portfolio-content">
                                            <span><a href="protfolio.html">Couple Fitness Workout</a></span>
                                            <p>Weight loss Program</p>
                                        </div>
                                        <div className="portfolio_d-icon">
                                            <a href="protfolio-details.html" className="tp-btn-circle"><i
                            ...
                            <div className="col-lg-6 c2 c1 c4 c5">
                                <div className="single_portfolio_item mb-30">
                                    <div className="portfolio_image">
                                        <a href="protfolio-details.html"><img src="assets/img/protfolio/portfolio6.jpg"
                                                                              alt=""/></a>
                                    </div>
                                    <div className="portfolio-info">
                                        <div className="portfolio-content">
                        ...
                        <div className="row mt-40">
                            <div className="col-12">
                                <div className="basic-pagination text-center mt-10 wow fadeInUp" data-wow-delay=".5s"
                                    ...
                                    <ul>
                                        ...
                                        <li><a className="page-numbers" href="protfolio.html">2</a></li>
                                        <li><a className="page-numbers" href="protfolio.html">3</a></li>
                                        <li><a className="next page-numbers" href="protfolio.html">
