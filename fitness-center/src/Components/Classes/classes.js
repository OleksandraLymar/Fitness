export default function Classes() {
    ...
    return (
        <section className="about-section text-center" id="classes">
            <body>
            <div id="preloader">
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="about.html" className="active">Pages <i
                                                    ...
                                                    <ul className="sub-menu">
                                                        <li><a href="classes.html" className="active">Classes</a></li>
            ...
            <main>
                        ...
                        <div className="row">
                            <div className="col-xl-12">
                                <div className="page__title-content text-center">
                                    <h3 className="breadcrumb-title breadcrumb-title-sd mb-15">Our classes</h3>
                ...
                <div className="classes-area pt-115 pb-80">
                    <div className="container custome-container">
                        <div className="row justify-content-center">
                            <div className="col-lg-12">
                                <div className="section-wrap-two text-center">
                                    <span className="tpsub-title-two mb-15"><i className="far fa-circle"></i>Our Classes<i
                                        className="far fa-circle"/></span>
                                    <h3 className="section-title-two  mb-30">Solutions for moving better and feeling a
                                        healthier</h3>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="container custome-container">
                        <div className="row mt-30">
                            <div className="col-lg-4 col-md-6">
                                <div className="single-class mb-40">
                                    <div className="class-iamge">
                                        <a href="classes-details.html"><img src="assets/img/classes/class-1.jpg"
                                                                            className="img-fluid" alt="class-img"/></a>
                                    </div>
                                    <div className="class-info text-center">
                                        <div className="class_icon mb-10">
                                            <i className="flaticon-muscle"></i>
                                        </div>
                                        <h4 className="class_title"><a href="classes-details.html">Power Yoga</a></h4>
                                        <div className="class_btn">
                                            <a href="classes-details.html">Read More<i
                                                className="fal fa-chevron-double-right"/></a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="single-class mb-40">
                                    <div className="class-iamge">
                                        <a href="classes-details.html"><img src="assets/img/classes/class-2.jpg"
                                                                            className="img-fluid" alt="class-img"/></a>
                                    </div>
                                    <div className="class-info text-center">
                                        <div className="class_icon mb-10">
                                        ...
                                        <h4 className="class_title"><a href="classes-details.html">Body Building</a>
                                        </h4>
                                        <div className="class_btn">
                                            <a href="classes-details.html">Read More<i
                                                className="fal fa-chevron-double-right"/></a>
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="single-class mb-40">
                                    <div className="class-iamge">
                                        <a href="classes-details.html"><img src="assets/img/classes/class-3.jpg"
                                                                            className="img-fluid" alt="class-img"/></a>
                                    </div>
                                    <div className="class-info text-center">
                                        <div className="class_icon mb-10">
                                        ...
                                        <h4 className="class_title"><a href="classes-details.html">Crosfit Tools</a>
                                        </h4>
                                        <div className="class_btn">
                                            <a href="classes-details.html">Read More<i
                                                className="fal fa-chevron-double-right"/></a>
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="single-class mb-40">
                                    <div className="class-iamge">
                                        <a href="classes-details.html"><img src="assets/img/classes/class-4.jpg"
                                                                            className="img-fluid" alt="class-img"/></a>
                                    </div>
                                    <div className="class-info text-center">
                                        <div className="class_icon mb-10">
                                        ...
                                        <h4 className="class_title"><a href="classes-details.html">Weight Lifting</a>
                                        </h4>
                                        <div className="class_btn">
                                            <a href="classes-details.html">Read More<i
                                                className="fal fa-chevron-double-right"/></a>
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="single-class mb-40">
                                    <div className="class-iamge">
                                        <a href="classes-details.html"><img src="assets/img/classes/class-5.jpg"
                                                                            className="img-fluid" alt="class-img"/></a>
                                    </div>
                                    <div className="class-info text-center">
                                        <div className="class_icon mb-10">
                                        ...
                                        <h4 className="class_title"><a href="classes-details.html">Nutrition Class</a>
                                        </h4>
                                        <div className="class_btn">
                                            <a href="classes-details.html">Read More<i
                                                className="fal fa-chevron-double-right"/></a>
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="single-class mb-40">
                                    <div className="class-iamge">
                                        <a href="classes-details.html"><img src="assets/img/classes/class-6.jpg"
                                                                            className="img-fluid" alt="class-img"/></a>
                                    </div>
                                    <div className="class-info text-center">
                                        <div className="class_icon mb-10">
                                        ...
                                        <h4 className="class_title"><a href="classes-details.html">Group Fitness</a>
                                        </h4>
                                        <div className="class_btn">
                                            <a href="classes-details.html">Read More<i
                                                className="fal fa-chevron-double-right"/></a>
                ...
                <div className="testimonial-area testimonial-area-two mb-120">
                                        ...
                                        <div className="testimonial-wrapper swiper-wrapper">
                                            <div className="testimonial-slider-item swiper-slide text-center">
                                                ...
                                                <div className="testimonial-info">
                                                    <p className="testimonial_description pb-50">Eleifend dis luctus be
                                                        hace sociis porta sociosqu praesent lobortis tortor augue enim
                                                        muse saoreet aenean litorace uterns dictum dolor convallis urnan
                                                        erose nulla semper elementum primis tempor enim hac ante id
                                                        sagittis suscipit nunc per luctus lacus utern aliquet nase vele
                                                        anic scelerisque dus dapibus feugiat scelerisque metre</p>
                                            ...
                                            <div className="testimonial-slider-item swiper-slide text-center">
                                                ...
                                                <div className="testimonial-info">
                                                    <p className="testimonial_description pb-50">Sagittis suscipit nunc
                                                        per luctus lacus utern aliquet nase vele anic scelerisque dus
                                                        dapibus feugiat scelerisque metre. eleifend dis luctus be hace
                                                        sociis porta sociosqu praesent lobortis tortor augue enim muse
                                                        saoreet aenean litorace uterns dictum dolor convallis urnan
                                                        erose nulla semper elementum primis tempor enim hac ante id.</p>
                                                    <h5 className="client-name">Calwen Andrew</h5>
                                                    <span className="client-degination">Sr Dev</span>
                                                </div>
                                            </div>
                                            <div className="testimonial-slider-item swiper-slide text-center">
                                                <div className="tesimonial-quote mb-60">
                                                ...
                                                <div className="testimonial-info">
                                                    <p className="testimonial_description pb-50">Saoreet aenean litorace
                                                        uterns dictum dolor convallis urnan erose nulla semper elementum
                                                        primis tempor enim hac. Eleifend dis luctus be hace sociis porta
                                                        sociosqu praesent lobortis tortor augue enim muse ante id
                                                        sagittis suscipit nunc per luctus lacus utern aliquet nase vele
                                                        anic scelerisque dus dapibus feugiat scelerisque metre</p>
                                                    <h5 className="client-name">Calwen Synton</h5>
                                                    <span className="client-degination">Sr Designer</span>
                ...
                <div className="customer_support_area pt-40  pb-75">
                    <div className="container">
                                ...
                                <div className="supportt-info">
                                    ...
                                    <form action="#">
                                        ...
                                        <div className="support-btn">
                                            <button type="submit" className="tp-btn-round">Get Estimate<i
